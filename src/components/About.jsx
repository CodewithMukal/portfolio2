...
export const About = () => {
  ...
  return (
    <div className="flex md:flex-row flex-col text-black gap-3 border-b-[1px] border-black dark:border-white pb-[50px] mt-[50px] dark:text-white">
      <img
        src={pic}
        className="lg:w-40 md:w-30 md:h-30 h-20 w-20 rounded-full lg:h-40"
        alt=""
      />
      <div className="w-full justify-around flex flex-col">
        <div className="flex justify-between">
          <div className="flex flex-col justify-center">
            <h1 className="text-3xl font-bold font-['IBM_Plex_Mono']">
              Mukal Markanda
            </h1>
            <p className="font-[Inter]">
              {string} Year Student at NIT Jalandhar
            </p>
          </div>
        ...
        <div>
          <p className="font-['IBM_Plex_Mono']">
            <br />I design to grab attention, code to crack problems, and build
            to make an impact every single day. If you’re looking for someone
            who doesn’t just talk innovation but actually builds it—I’m right
            here.
          </p>
        </div>
      </div>
